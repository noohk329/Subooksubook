...
public class BookViewAdapter extends BaseAdapter {
    ...
    // 지정한 위치(position)에 있는 데이터와 관계된 아이템(row)의 ID를 리턴. : 필수 구현s
    @Override
    ...
    public void addItem(String title, String author, String publisher, String imagebook, String progress) {
        ...
        mItem.setProgressPercent(progress);
    ...
    public String getProgress(int position) { return bookItemList.get(position).getProgressPercent();}
